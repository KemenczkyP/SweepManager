...
```bash
pip install git+https://gitlab.com/nje-ai-research-center/sweep_manager
```
...
```
cd existing_repo
git remote add origin https://gitlab.com/nje-ai-research-center/classificationmodeltrainer.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/nje-ai-research-center/classificationmodeltrainer/-/settings/integrations)
